...
export default class extends Controller {
  connect() {
    //$('.js-lazyload').lazyload({ effect: 'fadeIn', threshold: 50 });
    ...
    const swipeEnded = (event, direction, $card) => {
      var  directionFactor,
          transform;
  ...
  swipeLeft(event) {
    ...
    var $topCard= $('.js-swiping-card').last();
    this.swipeEnded(event, 'left', $topCard);
  ...
  swipeRight(event) {
    ...
    var $topCard = $('.js-swiping-card').last();
    this.swipeEnded(event, 'right', $topCard);
